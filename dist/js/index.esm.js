...
var Button = function Button(_ref) {
  ...
  return href ? React.createElement("a", _extends({
    "data-tip": true,
    "data-for": dataFor
  }, props), children) : React.createElement("button", _extends({
    type: type
  }, props, {
    disabled: disabled,
...
export { Button, Checkbox, CloseButton, InfoButton, LoadMask, PasswordField, PasswordStrengthMeter, Radio, TextArea, Textfield };
