(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('zxcvbn')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'zxcvbn'], factory) :
  (global = global || self, factory(global.astrosatui = {}, global.React, global.PropTypes, global.zxcvbn));
}(this, (function (exports, React, PropTypes, zxcvbn) { 'use strict';
  ...
  var PasswordField = function PasswordField(_ref) {
    ...
    }, isVisible ? React__default.createElement(InvisibleIcon, {
      className: passwordStyles.icon
    }) : React__default.createElement(VisibleIcon, {
      className: passwordStyles.icon
    })));
  };
