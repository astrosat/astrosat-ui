...
const LoadMask = () => (
  <div className={styles['load-mask']}>
    <svg width="100px" height="100px" viewBox="0 0 1000 1000">
      <circle cx="500" cy="570" r="80" stroke="#fff" fill="#fff" />
      <circle
        cx="500"
        cy="570"
        r="200"
      ...
      <g className={styles.spinner3}>
        <circle cx="300" cy="570" r="30" stroke="#fff" fill="#fff" />
      </g>
      <g className={styles.spinner4}>
        <circle cx="500" cy="366" r="30" stroke="#fff" fill="#fff" />
      </g>
      <g className={styles.spinner5}>
        <circle cx="500" cy="30" r="30" stroke="#fff" fill="#fff" />
      </g>
    </svg>
  </div>
);
