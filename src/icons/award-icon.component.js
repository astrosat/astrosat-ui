...
const AwardIcon = props => (
  <SvgIcon {...props}>
    ...
    />
    <path
      d="M17.28 7.823c1.57 0 2.841-1.248 2.841-2.786 0-1.539-1.272-2.786-2.84-2.786-1.57 0-2.84 1.247-2.84 2.786 0 1.538 1.27 2.786 2.84 2.786ZM15.86 8.958v3.043l1.42-1.393L18.7 12V8.958a4.058 4.058 0 0 1-2.84 0Z"
      fill="currentColor"
    />
  </SvgIcon>
);
