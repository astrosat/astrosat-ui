...
const MapIcon = props => (
  <SvgIcon {...props}>
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M14.853 5.613a.5.5 0 01.223 0l5.905 1.36a.5.5 0 01.388.487v15.827a.5.5 0 01-.597.49l-5.902-1.166-5.79 1.288a.501.501 0 01-.219 0L3.09 22.587a.5.5 0 01-.39-.488V6.36a.5.5 0 01.501-.5h.448a.5.5 0 01.101.01l5.218 1.078 5.886-1.335zM8.421 7.857L3.7 6.88v14.82l4.72 1.072V7.857zm1 14.942V7.871l5.157-1.17v14.95L9.421 22.8zm6.157-1.067V6.755l4.79 1.103v14.82l-4.79-.946z"
      fill="currentColor"
    />
    <path
